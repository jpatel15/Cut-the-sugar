	...
	<!-- //header -->
		...
		<section class="laboratory">
			<div class="inner-banner demo-2 text-center">
				...
				<div class="container">
					<h3 class="last-updated"> Overview</h3>
						<p><font size="4"><b>Nearly two out of three people in canada are overweight. Its not the condition that affects in older age, but also in young people it has been diagnosed</b></font></p>
						<p><font size="4"><b>Having a body mass index greater than 30 means its  overweight condition and also symptoms for type2 diabetes. </b></font></p>
						
						<figure><img  src="images/coo.jpg" align="middle" class="center" width="300" height="300"/> </figure>    
					...
					<div class="technologies">
				<div class="container">
					<h3 class="last-updated">Causes</h3>
						<p><font size="5"><b>proinflammatory chemicals is released by fat cells from Abdominal fat which makes body less sensitive to insulin. </b></font></p>
						<p><font size="4"><b>Thus the insulin responsive cells disfunction and they donot respond to insulin</b></font></p>
  ...
  <div class="inner">
    ...
    <div id="video-show">
      <div class="video-play"><a name="video" id="video"></a>
        <iframe width="748" height="422" src="//www.youtube.com/embed/PBB4SHQHTbY" frameborder="0" allowfullscreen></iframe>
        </div>
