			...
			<ul class="nav navbar-nav nav_1">
				...
				<li class="dropdown current_page">
				  ...
				  <ul class="dropdown-menu drop_menu" role="menu">
					...
					<li><a href="findDoctors.jsp">Search Doctors</a></li>
				  </ul>
				</li>
					...
					<h3>Register Here</h3>
						<p class="est">Cann't wait now. put information here and enjoy our services.</p>
							<div class="login-form-grids">
								...
								<h7>Gender :  <input type="radio" name="gender" value="M" >Male
								...
								<h6>Login information</h6>
									...
									<input type="email" name="email_id" placeholder="Email Address/Username" required=" " >
