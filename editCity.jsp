				...
				<div class="l-row">
					<div class="l-box l-spaced-bottom">
						...
						<div class="l-box-body l-spaced">
							<form action= "<%=request.getContextPath()%>/addCityController" method="post" role="form" data-parsley-validate class="form-horizontal">
								...
								<div class="form-group">
									<label for="msg" class="col-sm-3 control-label">City Name</label>
									<div class="col-sm-9">
										<input id="msg" type="text" name="Cityname" 
											 data-parsley-trigger="change"
											data-parsley-required required="" placeholder="" value="${i.cityName}"
											class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label for="msg" class="col-sm-3 control-label">City Description
										(20 chars min, 100 max)</label>
									<div class="col-sm-9">
										<textarea id="msg" name="Citydescription" required=""
											data-parsley-trigger="keyup" data-parsley-length="[20, 100]"
											data-parsley-validation-threshold="10"
											data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
											class="form-control">${i.cityDescription}</textarea>
									</div>
								</div>
