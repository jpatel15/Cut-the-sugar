<%@page import="model.AppoinmentModel"%>
<%@page import="com.bean.AppointmentBean"%>
<%@page import="com.bean.PataintBean"%>
...
<html>
<head>
<title>Health Companion  | Reports :: Health Companion</title>
...
<%
	...
	if(session.getAttribute("Email_Id").toString().trim().equals("") ){
	   ...
	   <!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
			<ul class="nav navbar-nav nav_1">
				...
				<li class="dropdown">
				   <a href="#" class="dropdown-toggle" data-toggle="dropdown">Your Panel<span class="caret"></span></a>
				  <ul class="dropdown-menu drop_menu" role="menu">
					<li><a href="DrreportsFiles.jsp">Reports</a></li>
					<li><a href="ViewAppointment.jsp">Appointment</a></li>
					<li><a href="contact.jsp">Contact</a></li>
					<li><a href="LoginDrController?Email_Id=<%=session.getAttribute("Email_Id")%>">Logout</a></li>
				  </ul>
				</li>
	...
	<!-- //header -->
		...
		<section class="login-page">
			...
			<div class="login">
				<div class="container">
					<h3>All Details Here</h3>
						<p class="est">Cann't wait now. put information here and enjoy our services.</p>
							<div class="login-form-grids">
									<h5>PATIENT Reports</h5>
								
								<% List<AppointmentBean> list= AppoinmentModel.getAppoinmentsList();
%>
		...
		<%-- <td><%=bean.getP_id() %> </td> --%>
		<td><%=bean.getName() %> </td>
		<td><%=bean.getP_gender() %> </td>
		<td><%=bean.getEmail() %> </td>
		<td><%=bean.getMob_number() %> </td>
		<td><%=bean.getAppdate() %> </td>
		<%-- <td><%=bean.getApptime() %> </td> --%>
		<% if(bean.getStatus()==0){ %>
		<td><a href="AppointmentController?req=accept&appid=<%=bean.getApp_id()%>"><%="Accept" %> </a></td>
		<%-- <td><a href=""><%="Suggest" %> </a></td> --%>
		<td><a href="AppointmentController?req=reject&appid=<%=bean.getApp_id()%>"><%="Reject" %> </a></td>
		...
		<%} %>
								...
								<label  for="email">EMAIL</label>
									<input type="email" id="email" name="email_id" placeholder="Email Address/Username" required=" "  readonly="readonly" >
        ...
        <div class="row">
            <div class="form-actions floatRight">
                <div class="login-para">
				 			<p><a href="DrreportsFiles.jsp"> Find Patients Reports here </a></p>
